...
class OldSKFile:
    ...
    def fromfile(cls, fname, homo):
        ...
        # the remaining content may contain the spline repulsive and hybrids tag
    ...
    def equals(self, ref, atol=1e-10, rtol=1e-09):
        ...
        if not equal:
            warnings.warn('Mismatch in the Hybrids extra tag.')
            return False
...
def generate_cam_extratag(cam_params):
    '''Generates the hybrids extra tag from CAM parameters.'''
